...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.LITTLEBABY_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.LITTLEBABY_SERVICE_MARKER;
    vi.useRealTimers();
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.LITTLEBABY_SERVICE_MARKER = originalServiceMarker;
    }
  });
