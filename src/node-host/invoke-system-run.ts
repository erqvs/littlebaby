...
type ExecToolConfig = NonNullable<NonNullable<LittleBabyConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<LittleBabyConfig> {
  if (opts.loadConfig) {
