...
const FACADE_LOADER_GLOBAL = "__littlebabyTestLoadBundledPluginPublicSurfaceModuleSync";
...
describe("plugin-sdk facade loader", () => {
  it("honors bundled plugin dir overrides outside the package root", () => {
    const overrideA = createBundledPluginDir("littlebaby-facade-loader-a-", "override-a");
    const overrideB = createBundledPluginDir("littlebaby-facade-loader-b-", "override-b");
  ...
  it("shares loaded facade ids with facade-runtime", () => {
    const dir = createBundledPluginDir("littlebaby-facade-loader-ids-", "identity-check");
  ...
  it("keeps Windows dist facade loads off Jiti native import", () => {
    const dir = createTempDirSync("littlebaby-facade-loader-windows-dist-");
  ...
  it("breaks circular facade re-entry during module evaluation", () => {
    const dir = createCircularPluginDir("littlebaby-facade-loader-circular-");
    process.env.LITTLEBABY_BUNDLED_PLUGINS_DIR = dir;
  ...
  it("clears the cache on load failure so retries re-execute", () => {
    const dir = createThrowingPluginDir("littlebaby-facade-loader-throw-");
    process.env.LITTLEBABY_BUNDLED_PLUGINS_DIR = dir;
