...
import type { ModelProviderConfig, LittleBabyConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyOpenrouterConfig: (cfg: LittleBabyConfig) => LittleBabyConfig;
  applyOpenrouterProviderConfig: (cfg: LittleBabyConfig) => LittleBabyConfig;
