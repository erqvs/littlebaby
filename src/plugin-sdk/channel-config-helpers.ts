...
type ChannelConfigAccessorParams<Config extends LittleBabyConfig = LittleBabyConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends LittleBabyConfig = LittleBabyConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends LittleBabyConfig = LittleBabyConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: LittleBabyConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends LittleBabyConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends LittleBabyConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends LittleBabyConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
