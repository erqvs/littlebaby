...
const shouldWarnCompatImport =
  ...
  process.env.LITTLEBABY_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "littlebaby/plugin-sdk/compat is deprecated for new plugins. Migrate to focused littlebaby/plugin-sdk/<subpath> imports. See https://docs.littlebaby.ai/plugins/sdk-migration",
    {
      code: "LITTLEBABY_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.littlebaby.ai/plugins/sdk-migration",
    },
  );
}
