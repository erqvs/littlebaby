...
import { getRuntimeConfigSnapshot, type LittleBabyConfig } from "../../config/config.js";
import {
...
export function resolveQueuedReplyRuntimeConfig(config: LittleBabyConfig): LittleBabyConfig {
  return (
