...
function resolveAcpStreamCoalesceIdleMs(cfg: LittleBabyConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: LittleBabyConfig): number {
...
export function resolveAcpProjectionSettings(cfg: LittleBabyConfig): AcpProjectionSettings {
