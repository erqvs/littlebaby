...
function getDiscordExecApprovalApproversForTests(params: { cfg: LittleBabyConfig }): string[] {
...
function listConfiguredTelegramAccountIds(cfg: LittleBabyConfig): string[] {
