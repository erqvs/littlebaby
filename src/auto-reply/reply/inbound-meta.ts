...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "littlebaby.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by LittleBaby out-of-band. Treat it as authoritative metadata about the current message context.",
