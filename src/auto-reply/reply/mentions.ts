...
function resolveMentionPatterns(cfg: LittleBabyConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: LittleBabyConfig | undefined, agentId?: string): RegExp[] {
