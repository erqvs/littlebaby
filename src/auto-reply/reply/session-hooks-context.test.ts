...
describe("session hook context wiring", () => {
  ...
  it("passes sessionKey to session_start hook context", async () => {
    ...
    const storePath = await createStorePath("littlebaby-session-hook-start");
  ...
  it("passes sessionKey to session_end hook context on reset", async () => {
    const sessionKey = "agent:main:telegram:direct:123";
    const storePath = await createStorePath("littlebaby-session-hook-end");
  ...
  it("marks explicit /reset rollovers with reason reset", async () => {
    ...
    const storePath = await createStorePath("littlebaby-session-hook-explicit-reset");
  ...
  it("maps custom reset trigger aliases to the new-session reason", async () => {
    ...
    const storePath = await createStorePath("littlebaby-session-hook-reset-alias");
  ...
  it("marks daily stale rollovers and exposes the archived transcript path", async () => {
    ...
    try {
      ...
      const storePath = await createStorePath("littlebaby-session-hook-daily");
  ...
  it("marks idle stale rollovers with reason idle", async () => {
    ...
    try {
      ...
      const storePath = await createStorePath("littlebaby-session-hook-idle");
  ...
  it("prefers idle over daily when both rollover conditions are true", async () => {
    ...
    try {
      ...
      const storePath = await createStorePath("littlebaby-session-hook-overlap");
