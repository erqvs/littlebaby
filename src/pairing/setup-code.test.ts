...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    vi.stubEnv("LITTLEBABY_GATEWAY_TOKEN", "");
    vi.stubEnv("LITTLEBABY_GATEWAY_PASSWORD", "");
    vi.stubEnv("LITTLEBABY_GATEWAY_PORT", "");
  });
  ...
  it.each([
    ...
    {
      name: "uses LITTLEBABY_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          LITTLEBABY_GATEWAY_TOKEN: "new-token",
        },
