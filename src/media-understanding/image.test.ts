...
const hoisted = vi.hoisted(() => ({
  completeMock: vi.fn(),
  ensureLittleBabyModelsJsonMock: vi.fn(async () => {}),
...
const {
  completeMock,
  ensureLittleBabyModelsJsonMock,
...
vi.mock("../agents/models-config.js", async () => ({
  ...
  ensureLittleBabyModelsJson: ensureLittleBabyModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureLittleBabyModelsJsonMock).toHaveBeenCalled();
