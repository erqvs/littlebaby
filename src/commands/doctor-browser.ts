...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: LittleBabyConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: LittleBabyConfig, deps?: BrowserDoctorDeps) {
  try {
