...
export function collectMissingDefaultAccountBindingWarnings(cfg: LittleBabyConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: LittleBabyConfig): string[] {
  const warnings: string[] = [];
