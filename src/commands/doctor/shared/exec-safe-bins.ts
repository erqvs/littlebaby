...
function collectExecSafeBinScopes(cfg: LittleBabyConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: LittleBabyConfig): ExecSafeBinCoverageHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: LittleBabyConfig): {
