...
export function scanLegacyToolsBySenderKeys(cfg: LittleBabyConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: LittleBabyConfig): {
