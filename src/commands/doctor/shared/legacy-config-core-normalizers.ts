...
export function normalizeLegacyBrowserConfig(
  ...
  return {
    ...cfg,
    browser: browser as LittleBabyConfig["browser"],
  };
}
...
export function seedMissingDefaultAccountsFromSingleAccountBase(
  ...
  return {
    ...cfg,
    channels: nextChannels as LittleBabyConfig["channels"],
  };
}

type ModelProviderEntry = Partial<
  NonNullable<NonNullable<LittleBabyConfig["models"]>["providers"]>[string]
>;
type ModelsConfigPatch = Partial<NonNullable<LittleBabyConfig["models"]>>;
...
export function normalizeLegacyNanoBananaSkill(
  ...
  if (!hasGoogleApiKey && legacyApiKey) {
    ...
    rawModels.providers = rawProviders as NonNullable<LittleBabyConfig["models"]>["providers"];
    next = {
      ...next,
      models: rawModels as LittleBabyConfig["models"],
    };
    changes.push(
...
export function normalizeLegacyMediaProviderOptions(
  ...
  return {
    ...
    tools: {
      ...cfg.tools,
      media: nextMedia as NonNullable<LittleBabyConfig["tools"]>["media"],
    },
  };
}
...
export function normalizeLegacyMistralModelMaxTokens(
  ...
  return {
    ...
    models: {
      ...cfg.models,
      providers: nextProviders as NonNullable<LittleBabyConfig["models"]>["providers"],
    },
  };
}
