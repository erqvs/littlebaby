...
const MANAGED_SERVICE_ENV_KEYS_VAR = "LITTLEBABY_SERVICE_MANAGED_ENV_KEYS";
  ...
  const serviceEnvironment = buildServiceEnvironment({
    ...
    launchdLabel:
      process.platform === "darwin"
        ? resolveGatewayLaunchAgentLabel(params.env.LITTLEBABY_PROFILE)
        : undefined,
