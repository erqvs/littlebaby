...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    ensureLittleBabyModelsJson: vi.fn(),
...
function resetMocks() {
  ...
  mocks.ensureLittleBabyModelsJson.mockResolvedValue({ wrote: false });
...
function installModelsListCommandForwardCompatMocks() {
  ...
  vi.doMock("./list.runtime.js", () => ({
    ensureLittleBabyModelsJson: mocks.ensureLittleBabyModelsJson,
