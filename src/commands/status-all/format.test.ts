...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://littlebaby.local")).toBe("https://littlebaby.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://littlebaby.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: littlebaby security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://littlebaby.local" },
      ...
      { Item: "Security", Value: "Run: littlebaby security audit --deep" },
