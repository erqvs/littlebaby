...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.littlebaby.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("littlebaby hooks list")}`,
      `  ${formatCliCommand("littlebaby hooks enable <name>")}`,
      `  ${formatCliCommand("littlebaby hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
