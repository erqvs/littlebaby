...
function resolveDefaultAccountId(cfg: LittleBabyConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: LittleBabyConfig): boolean {
...
export function summarizeBindings(cfg: LittleBabyConfig, bindings: AgentBinding[]): string[] {
