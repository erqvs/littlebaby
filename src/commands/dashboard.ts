...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set LITTLEBABY_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `littlebaby dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control LittleBaby.");
  } else if (hint) {
    runtime.log(hint);
  }
}
