...
function resolveCollectionNamesForAgent(cfg: LittleBabyConfig, agentId: string): Set<string> {
  return new Set(
...
function resolveCustomCollectionPathsForAgent(cfg: LittleBabyConfig, agentId: string): string[] {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as LittleBabyConfig;
