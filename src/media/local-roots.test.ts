...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "littlebaby-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "littlebaby-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "littlebaby-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "littlebaby-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "littlebaby-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "littlebaby-legacy-state");
    const configDir = path.join("/tmp", "littlebaby-current-config");
