...
export type WideAreaDiscoveryConfig = {
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "littlebaby.internal"). */
  domain?: string;
};
...
export type CanvasHostConfig = {
  enabled?: boolean;
  /** Directory to serve (default: ~/.littlebaby/workspace/canvas). */
  root?: string;
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/littlebaby"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__littlebaby__/canvas or /__littlebaby__/a2ui content.
   */
 ...
 * Used when LittleBaby runs behind an identity-aware proxy (Pomerium, Caddy + OAuth, etc.)
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/littlebaby/littlebaby/issues/47711
   */
