...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.LITTLEBABY_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.LITTLEBABY_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.LITTLEBABY_WATCH_COMMAND),
