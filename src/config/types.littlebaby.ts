...
export type LittleBabyConfig = {
  ...
  $schema?: string;
  meta?: {
    /** Last LittleBaby version that wrote this config. */
  ...
  ui?: {
    /** Accent color for LittleBaby UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const littleBabyConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = LittleBabyConfig & {
  readonly [littleBabyConfigStateBrand]?: TState;
};
