...
export const InstallRecordShape = {
  ...
  littlebabyhubUrl: z.string().optional(),
  littlebabyhubPackage: z.string().optional(),
  littlebabyhubFamily: z.union([z.literal("code-plugin"), z.literal("bundle-plugin")]).optional(),
  littlebabyhubChannel: z
