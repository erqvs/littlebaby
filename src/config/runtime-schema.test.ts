...
import type { ConfigFileSnapshot, LittleBabyConfig } from "./types.js";

const mockLoadConfig = vi.hoisted(() => vi.fn<() => LittleBabyConfig>());
...
function makeSnapshot(params: { valid: boolean; config?: LittleBabyConfig }): ConfigFileSnapshot {
  return {
