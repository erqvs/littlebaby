...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof LittleBabyConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: LittleBabyConfig; env: NodeJS.ProcessEnv }): {
  cfg: LittleBabyConfig;
  changes: string[];
} {
