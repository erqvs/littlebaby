...
export function listBindings(cfg: LittleBabyConfig): AgentRouteBinding[] {
  return listRouteBindings(cfg);
}

export function listBoundAccountIds(cfg: LittleBabyConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: LittleBabyConfig) {
