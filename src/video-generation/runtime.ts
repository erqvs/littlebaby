...
function buildNoVideoGenerationModelConfiguredMessage(cfg: LittleBabyConfig): string {
...
export function listRuntimeVideoGenerationProviders(params?: { config?: LittleBabyConfig }) {
