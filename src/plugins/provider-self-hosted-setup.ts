...
export function applyProviderDefaultModel(cfg: LittleBabyConfig, modelRef: string): LittleBabyConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: LittleBabyConfig; modelId: string; modelRef: string; profileId: string } {
