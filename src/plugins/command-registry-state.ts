...
import type { LittleBabyPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = LittleBabyPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("littlebaby.pluginCommandsState");
