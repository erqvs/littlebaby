...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: LittleBabyConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: LittleBabyConfig, value: unknown) => void;
  applySelectionConfig?: (config: LittleBabyConfig) => LittleBabyConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => LittleBabyConfig | Promise<LittleBabyConfig>;
