...
export function applyGoogleGeminiModelDefault(cfg: LittleBabyConfig): {
...
export function applyOpenAIProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
...
export function applyOpenAIConfig(cfg: LittleBabyConfig): LittleBabyConfig {
...
export function applyOpencodeGoModelDefault(cfg: LittleBabyConfig): {
  next: LittleBabyConfig;
  changed: boolean;
} {
