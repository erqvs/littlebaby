...
import type { LittleBabyPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: LittleBabyPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): LittleBabyPluginConfigSchema {
  return {
