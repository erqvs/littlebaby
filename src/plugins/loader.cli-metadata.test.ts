...
describe("plugin loader CLI metadata", () => {
  ...
  register(api) {
    ...
    const registry = await loadLittleBabyPluginCliRegistry({
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@littlebaby/cli-metadata-channel",
          littlebaby: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    process.env.LITTLEBABY_BUNDLED_PLUGINS_DIR = bundledRoot;

    fs.writeFileSync(
      path.join(pluginDir, "package.json"),
      JSON.stringify(
        {
          name: "@littlebaby/bundled-skip-channel",
          littlebaby: { extensions: ["./index.cjs"] },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@littlebaby/bundled-cli-channel",
          littlebaby: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@littlebaby/bundled-skip-provider",
          littlebaby: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@littlebaby/full-cli-metadata-channel",
          littlebaby: { extensions: ["./index.cjs"] },
        },
        null,
        2,
