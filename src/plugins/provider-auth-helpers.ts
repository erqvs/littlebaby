...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveLittleBabyAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: LittleBabyConfig): SecretRef {
