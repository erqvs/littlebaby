...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type LittleBabyConfig } from "littlebaby/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "littlebaby/plugin-sdk/status-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiLittleBabyConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "littlebaby/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "littlebaby/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "littlebaby/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "littlebaby/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "littlebaby/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "littlebaby/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "littlebaby/plugin-sdk/channel-status";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "littlebaby/plugin-sdk/config-runtime";',
    ...
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "littlebaby/plugin-sdk/googlechat-runtime-shared";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "littlebaby/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "littlebaby/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "littlebaby/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, LittleBabyConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "littlebaby/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "littlebaby/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile({
    ...
    'export * from "littlebaby/plugin-sdk/nextcloud-talk";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      'export type { LittleBabyPluginApi } from "littlebaby/plugin-sdk/plugin-entry";',
      'export type { ChannelMessageActionAdapter } from "littlebaby/plugin-sdk/channel-contract";',
      'export type { TelegramApiOverride } from "./src/send.js";',
      'export type { LittleBabyPluginService, LittleBabyPluginServiceContext, PluginLogger } from "littlebaby/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "littlebaby/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "littlebaby/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "littlebaby/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "littlebaby/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "littlebaby/plugin-sdk/channel-core";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "littlebaby/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "littlebaby/plugin-sdk/channel-actions";',
      ...
      'export type { LittleBabyConfig } from "littlebaby/plugin-sdk/config-runtime";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeLittleBabyConfig["channels"]>["telegram"] >;',
