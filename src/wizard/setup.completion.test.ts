...
describe("setupWizardShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("littlebaby");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "littlebaby");
