...
export function buildGatewayConnectionDetailsWithResolvers(
  ...
  const envUrlOverride = cliUrlOverride
    ? undefined
    : normalizeOptionalString(process.env.LITTLEBABY_GATEWAY_URL);
  ...
  const allowPrivateWs = process.env.LITTLEBABY_ALLOW_INSECURE_PRIVATE_WS === "1";
