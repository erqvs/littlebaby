...
import type { ConfigValidationIssue, LittleBabyConfig } from "../../config/types.littlebaby.js";
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: LittleBabyConfig; schema: ConfigSchemaResponse } | null {
...
function didSharedGatewayAuthChange(prev: LittleBabyConfig, next: LittleBabyConfig): boolean {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, loadConfig() and loadLittleBabyPlugins() (called inside
