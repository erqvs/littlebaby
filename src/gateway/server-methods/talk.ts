...
import type { LittleBabyConfig, TtsConfig, TtsProviderConfigMap } from "../../config/types.js";
import {
...
function buildTalkTtsConfig(
  ...
  | { cfg: LittleBabyConfig; provider: string; providerConfig: TalkProviderConfig }
