...
vi.mock("../../infra/littlebaby-root.js", async () => {
  const actual = await vi.importActual<typeof import("../../infra/littlebaby-root.js")>(
    "../../infra/littlebaby-root.js",
  );
  return {
    ...actual,
    resolveLittleBabyPackageRoot: async () => "/tmp/littlebaby",
  };
});
