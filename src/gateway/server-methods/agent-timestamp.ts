 ...
 *
 * @see https://github.com/littlebaby/littlebaby/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an LittleBabyConfig.
 */
export function timestampOptsFromConfig(cfg: LittleBabyConfig): TimestampInjectionOptions {
  return {
