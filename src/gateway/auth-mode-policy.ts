...
export function hasAmbiguousGatewayAuthModeConfig(cfg: LittleBabyConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: LittleBabyConfig): void {
