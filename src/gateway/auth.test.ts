...
describe("gateway auth", () => {
  ...
  it("resolves token/password from LITTLEBABY gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          LITTLEBABY_GATEWAY_TOKEN: "env-token",
          LITTLEBABY_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides LITTLEBABY_GATEWAY_PASSWORD", () => {
...
describe("trusted-proxy auth", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      env: {
        LITTLEBABY_GATEWAY_TOKEN: "shared-secret",
      } as NodeJS.ProcessEnv,
    },
