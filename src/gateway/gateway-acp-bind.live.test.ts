...
const ACP_BIND_LIVE = isTruthyEnvValue(process.env.LITTLEBABY_LIVE_ACP_BIND);
  ...
  it(
    ...
    async () => {
      const previous = {
        ...
        port: process.env.LITTLEBABY_GATEWAY_PORT,
      ...
      try {
        ...
        if (previous.port === undefined) {
          ...
          process.env.LITTLEBABY_GATEWAY_PORT = previous.port;
        }
