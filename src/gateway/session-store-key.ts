...
function resolveDefaultStoreAgentId(cfg: LittleBabyConfig): string {
...
export function resolveSessionStoreAgentId(cfg: LittleBabyConfig, canonicalKey: string): string {
