...
export function collectConfiguredModelPricingRefs(config: LittleBabyConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: LittleBabyConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
