...
const EMPTY_CFG = {} as LittleBabyConfig;
...
async function applySubagentModelPatch(cfg: LittleBabyConfig) {
...
function createAllowlistedAnthropicModelCfg(): LittleBabyConfig {
  return {
    agents: {
      defaults: {
