...
export const A2UI_PATH = "/__littlebaby__/a2ui";

export const CANVAS_HOST_PATH = "/__littlebaby__/canvas";

export const CANVAS_WS_PATH = "/__littlebaby__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.littlebabyCanvasA2UIAction.postMessage(...)
  // - Android: window.littlebabyCanvasA2UIAction.postMessage(...)
  const handlerNames = ["littlebabyCanvasA2UIAction"];
  ...
  globalThis.LittleBaby = globalThis.LittleBaby ?? {};
  globalThis.LittleBaby.postMessage = postToNode;
  globalThis.LittleBaby.sendUserAction = sendUserAction;
  globalThis.littlebabyPostMessage = postToNode;
  globalThis.littlebabySendUserAction = sendUserAction;
