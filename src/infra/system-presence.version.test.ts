  ...
  return withEnvAsync(
    {
      ...
      LITTLEBABY_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when LITTLEBABY_VERSION is not set", async () => {
  ...
  it("prefers LITTLEBABY_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over LITTLEBABY_SERVICE_VERSION when LITTLEBABY_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        LITTLEBABY_VERSION: " ",
        LITTLEBABY_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when LITTLEBABY_VERSION and LITTLEBABY_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        LITTLEBABY_VERSION: " ",
        LITTLEBABY_SERVICE_VERSION: "\t",
