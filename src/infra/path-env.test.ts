...
describe("ensureLittleBabyCliOnPath", () => {
  ...
  function resetBootstrapEnv(pathValue = "/usr/bin") {
    ...
    delete process.env.LITTLEBABY_PATH_BOOTSTRAPPED;
    delete process.env.LITTLEBABY_ALLOW_PROJECT_LOCAL_BIN;
  ...
  it.each([
    ...
    ({ envValue, allowProjectLocalBin }) => {
      ...
      const localCli = path.join(localBinDir, "littlebaby");
      ...
      if (envValue === undefined) {
        ...
        process.env.LITTLEBABY_ALLOW_PROJECT_LOCAL_BIN = envValue;
      }
