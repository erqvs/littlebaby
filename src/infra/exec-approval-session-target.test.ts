...
function resolveSlackPluginOriginTarget(params: { cfg: LittleBabyConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "littlebaby-exec-approval-session-target-" }, (tmpDir) => {
