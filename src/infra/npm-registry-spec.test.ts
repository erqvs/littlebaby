...
describe("npm registry spec validation", () => {
  it.each([
    ...
    "@littlebaby/voice-call@1.2.3",
    "@littlebaby/voice-call@1.2.3-beta.4",
    "@littlebaby/voice-call@latest",
    "@littlebaby/voice-call@beta",
  ])("accepts %s", (spec) => {
  ...
  it.each([
    ...
    {
      spec: "git+ssh://github.com/littlebaby/littlebaby",
      expected: "URLs are not allowed",
    },
    {
...
describe("npm registry spec parsing helpers", () => {
  it.each([
    ...
    },
    {
      ...
      expected: {
        name: "@littlebaby/voice-call",
        raw: "@littlebaby/voice-call@beta",
        selector: "beta",
        selectorKind: "tag",
        selectorIsPrerelease: false,
      },
    ...
    {
      spec: "@littlebaby/voice-call@1.2.3-beta.1",
      expected: {
        name: "@littlebaby/voice-call",
        raw: "@littlebaby/voice-call@1.2.3-beta.1",
...
describe("npm prerelease resolution policy", () => {
  it.each([
    ...
    {
      spec: "@littlebaby/voice-call@latest",
  ...
  it.each([
    {
      spec: "@littlebaby/voice-call",
      resolvedVersion: "1.2.3-beta.1",
      expected: `Use "@littlebaby/voice-call@beta"`,
    },
    {
      spec: "@littlebaby/voice-call@beta",
      resolvedVersion: "1.2.3-rc.1",
