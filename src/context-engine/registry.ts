...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("littlebaby.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("littlebaby.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: LittleBabyConfig): Promise<ContextEngine> {
