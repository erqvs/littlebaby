...
function configWithSlot(engineId: string): LittleBabyConfig {
...
describe("Invalid engine fallback", () => {
  ...
  it("throws when the default engine itself is not registered", async () => {
    ...
    const registryState = (globalThis as Record<symbol, unknown>)[
      Symbol.for("littlebaby.contextEngineRegistryState")
...
// lossless-littlebaby registered successfully but resolution could not find it.
// ═══════════════════════════════════════════════════════════════════════════
