...
export function asConfig(value: unknown): LittleBabyConfig {
...
export function createOpenAIFileRuntimeConfig(secretFile: string): LittleBabyConfig {
  return asConfig({
    secrets: {
      providers: {
        default: {
