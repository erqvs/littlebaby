...
export function listAuthProfileStorePaths(config: LittleBabyConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: LittleBabyConfig, stateDir: string): string[] {
