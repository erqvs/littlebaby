...
function resolveResolutionLimits(config: LittleBabyConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: LittleBabyConfig): SecretProviderConfig {
