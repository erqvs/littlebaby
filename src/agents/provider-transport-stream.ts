...
const SIMPLE_TRANSPORT_API_ALIAS: Record<string, Api> = {
  "openai-responses": "littlebaby-openai-responses-transport",
  "openai-codex-responses": "littlebaby-openai-responses-transport",
  "openai-completions": "littlebaby-openai-completions-transport",
  "azure-openai-responses": "littlebaby-azure-openai-responses-transport",
  "anthropic-messages": "littlebaby-anthropic-messages-transport",
  "google-generative-ai": "littlebaby-google-generative-ai-transport",
};
