...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureLittleBabyModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createLittleBabyCodingTools({
      exec: {
    ...
    const filteredBundledTools = applyFinalEffectiveToolPolicy({
      ...
      // createLittleBabyCodingTools(...) also omit it, so both paths resolve
