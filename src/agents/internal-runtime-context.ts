export const INTERNAL_RUNTIME_CONTEXT_BEGIN = "<<<BEGIN_LITTLEBABY_INTERNAL_CONTEXT>>>";
export const INTERNAL_RUNTIME_CONTEXT_END = "<<<END_LITTLEBABY_INTERNAL_CONTEXT>>>";

const ESCAPED_INTERNAL_RUNTIME_CONTEXT_BEGIN = "[[LITTLEBABY_INTERNAL_CONTEXT_BEGIN]]";
const ESCAPED_INTERNAL_RUNTIME_CONTEXT_END = "[[LITTLEBABY_INTERNAL_CONTEXT_END]]";
