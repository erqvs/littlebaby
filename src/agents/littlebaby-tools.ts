...
import { applyNodesToolWorkspaceGuard } from "./littlebaby-tools.nodes-workspace-guard.js";
import {
  collectPresentLittleBabyTools,
  isUpdatePlanToolEnabledForLittleBabyTools,
} from "./littlebaby-tools.registration.js";
...
export function createLittleBabyTools(
  options?: {
  ...
  const tools: AnyAgentTool[] = [
    ...
    ...collectPresentLittleBabyTools([imageGenerateTool, musicGenerateTool, videoGenerateTool]),
    createGatewayTool({
      agentSessionKey: options?.agentSessionKey,
      config: options?.config,
    }),
    ...
    createSessionsListTool({
      ...
      sandboxed: options?.sandboxed,
      config: resolvedConfig,
      callGateway: littleBabyToolsDeps.callGateway,
    }),
    ...
    ...collectPresentLittleBabyTools([webSearchTool, webFetchTool, imageTool, pdfTool]),
  ];
