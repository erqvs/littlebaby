...
async function resolveContext(config: LittleBabyConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): LittleBabyConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
