...
const CLEANUP_STATE_KEY = Symbol.for("littlebaby.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("littlebaby.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("littlebaby.sessionWriteLockWatchdogState");
