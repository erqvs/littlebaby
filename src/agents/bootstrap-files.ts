...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "littlebaby:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: LittleBabyConfig): AgentContextInjection {
