...
import { resolveLittleBabyPluginToolInputs } from "./littlebaby-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("littlebaby plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveLittleBabyPluginToolInputs({
      options: {
        config: {} as never,
