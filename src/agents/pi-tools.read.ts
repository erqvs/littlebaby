...
type LittleBabyReadToolOptions = {
...
function resolveAdaptiveReadMaxBytes(options?: LittleBabyReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createLittleBabyReadTool(base, {
...
export function createLittleBabyReadTool(
  base: AnyAgentTool,
  options?: LittleBabyReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
