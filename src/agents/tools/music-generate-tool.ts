...
export function createMusicGenerateTool(options?: {
  ...
  return {
    ...
    description:
      "Generate music using configured providers. Generated tracks are saved under LittleBaby-managed media storage and delivered automatically as attachments.",
