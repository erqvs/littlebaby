...
export function resolveSessionToolsVisibility(cfg: LittleBabyConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: LittleBabyConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: LittleBabyConfig): AgentToAgentPolicy {
