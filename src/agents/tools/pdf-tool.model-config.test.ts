...
const TEST_AGENT_DIR = "/tmp/littlebaby-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  resolveDefaultModelRef: (cfg?: LittleBabyConfig) => {
...
function withDefaultModel(primary: string): LittleBabyConfig {
  return {
