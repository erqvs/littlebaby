...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<LittleBabyConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<LittleBabyConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: LittleBabyConfig): WebSearchConfig {
