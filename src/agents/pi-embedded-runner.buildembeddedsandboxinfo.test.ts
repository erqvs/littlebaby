...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/littlebaby-sandbox",
    agentWorkspaceDir: "/tmp/littlebaby-workspace",
    workspaceAccess: "none",
    runtimeId: "littlebaby-sbx-test",
    runtimeLabel: "littlebaby-sbx-test",
    ...
    browser: {
      ...
      containerName: "littlebaby-sbx-browser-test",
    },
