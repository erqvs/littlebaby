...
export function createPiToolsSandboxContext(params: PiToolsSandboxContextParams): SandboxContext {
  ...
  return {
    ...
    runtimeId: params.containerName ?? "littlebaby-sbx-test",
    runtimeLabel: params.containerName ?? "littlebaby-sbx-test",
    containerName: params.containerName ?? "littlebaby-sbx-test",
