...
export function isConfigPathTruthy(config: LittleBabyConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["littlebaby-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: LittleBabyConfig): string[] | undefined {
