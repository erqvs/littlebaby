...
function hasConfiguredSkillApiKeyRef(config?: LittleBabyConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: LittleBabyConfig): LittleBabyConfig | undefined {
