...
function resolveWatchPaths(workspaceDir: string, config?: LittleBabyConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: LittleBabyConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: LittleBabyConfig }) {
