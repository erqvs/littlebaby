...
export const DEFAULT_SANDBOX_IMAGE = "littlebaby-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "littlebaby-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "littlebaby-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "littlebaby-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-04-05-cdp-source-range";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "littlebaby-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "littlebaby-sandbox-browser";
