...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.LITTLEBABY_BUNDLED_PLUGINS_DIR;
  delete env.LITTLEBABY_SKIP_PROVIDERS;
  delete env.LITTLEBABY_SKIP_CHANNELS;
  delete env.LITTLEBABY_SKIP_CRON;
  delete env.LITTLEBABY_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,
