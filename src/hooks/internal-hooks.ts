/**
 * Hook system for LittleBaby agent events
 *
 ...
 */
const INTERNAL_HOOK_HANDLERS_KEY = Symbol.for("littlebaby.internalHookHandlers");
...
const INTERNAL_HOOKS_ENABLED_KEY = Symbol.for("littlebaby.internalHooksEnabled");
