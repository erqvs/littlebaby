...
type ConfigGroupPolicyWarningCollector<Params extends { cfg: LittleBabyConfig }> = (
  params: Params,
) => string[];
...
export function projectConfigWarningCollector<Params extends { cfg: LittleBabyConfig }>(
  collector: WarningCollector<{ cfg: LittleBabyConfig }>,
): WarningCollector<Params> {
  return projectWarningCollector((params) => ({ cfg: params.cfg }), collector);
}

export function projectConfigAccountIdWarningCollector<
  Params extends { cfg: LittleBabyConfig; accountId?: string | null },
>(
  collector: WarningCollector<{ cfg: LittleBabyConfig; accountId?: string | null }>,
): WarningCollector<Params> {
...
export function projectAccountConfigWarningCollector<
  ResolvedAccount,
  ProjectedCfg,
  Params extends { account: ResolvedAccount; cfg: LittleBabyConfig },
>(
  projectCfg: (cfg: LittleBabyConfig) => ProjectedCfg,
...
export function createAllowlistProviderRestrictSendersWarningCollector<ResolvedAccount>(
  params: {
    providerConfigPresent: (cfg: LittleBabyConfig) => boolean;
  ...
  return createAllowlistProviderGroupPolicyWarningCollector({
    providerConfigPresent: params.providerConfigPresent,
    resolveGroupPolicy: ({ account }: { account: ResolvedAccount; cfg: LittleBabyConfig }) =>
...
export function createAllowlistProviderGroupPolicyWarningCollector<
  Params extends { cfg: LittleBabyConfig },
>(params: {
  providerConfigPresent: (cfg: LittleBabyConfig) => boolean;
