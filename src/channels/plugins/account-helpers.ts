...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: LittleBabyConfig): string | undefined {
  ...
  function listAccountIds(cfg: LittleBabyConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: LittleBabyConfig): string {
