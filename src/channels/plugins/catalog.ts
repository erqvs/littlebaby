...
import type { LittleBabyPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["LITTLEBABY_PLUGIN_CATALOG_PATHS", "LITTLEBABY_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<LittleBabyPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
