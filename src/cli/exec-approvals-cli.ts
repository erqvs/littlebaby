...
import { readBestEffortConfig, type LittleBabyConfig } from "../config/config.js";
...
export function registerExecApprovalsCli(program: Command) {
  ...
  const approvals = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/approvals", "docs.littlebaby.ai/cli/approvals")}\n`,
    );
