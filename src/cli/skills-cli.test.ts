...
describe("skills-cli", () => {
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("littlebaby skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("littlebaby skills install");
    });
    ...
    it("shows API key storage guidance for the active config path", () => {
      ...
      expect(output).toContain("LITTLEBABY_CONFIG_PATH");
      expect(output).toContain("default: ~/.littlebaby/littlebaby.json");
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("littlebaby skills update");
    });
