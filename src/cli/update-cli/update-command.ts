...
const POST_CORE_UPDATE_ENV = "LITTLEBABY_UPDATE_POST_CORE";
const POST_CORE_UPDATE_CHANNEL_ENV = "LITTLEBABY_UPDATE_POST_CORE_CHANNEL";
...
export async function updateCommand(opts: UpdateCommandOptions): Promise<void> {
  ...
  const devTargetRef =
    channel === "dev" ? process.env.LITTLEBABY_UPDATE_DEV_TARGET_REF?.trim() || undefined : undefined;
