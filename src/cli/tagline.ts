const DEFAULT_TAGLINE = "All your chats, one LittleBaby.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little littlebaby-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew littlebabys—type something and let the bot pinch the busywork.",
  ...
  "Automation with littlebabys: minimal fuss, maximal pinch.",
  ...
  "LittleBabys out, commit in—let's ship something mildly responsible.",
  ...
  "You had me at 'littlebaby gateway start.'",
