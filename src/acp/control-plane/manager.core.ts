...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: LittleBabyConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: LittleBabyConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: LittleBabyConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: LittleBabyConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: LittleBabyConfig }): Promise<void> {
