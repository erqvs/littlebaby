...
export function isAcpEnabledByPolicy(cfg: LittleBabyConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: LittleBabyConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: LittleBabyConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: LittleBabyConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: LittleBabyConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: LittleBabyConfig, agentId: string): boolean {
