...
function resolveSpeechProviderPluginEntries(cfg?: LittleBabyConfig): SpeechProviderPlugin[] {
...
export function listSpeechProviders(cfg?: LittleBabyConfig): SpeechProviderPlugin[] {
