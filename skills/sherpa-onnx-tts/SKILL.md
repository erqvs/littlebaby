...
1. Download the runtime for your OS (extracts into `$LITTLEBABY_STATE_DIR/tools/sherpa-onnx-tts/runtime`, default `~/.littlebaby/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `$LITTLEBABY_STATE_DIR/tools/sherpa-onnx-tts/models`, default `~/.littlebaby/tools/sherpa-onnx-tts/models`)
