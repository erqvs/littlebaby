...
8. **NEVER start Codex inside your OpenClaw state directory** (`$LITTLEBABY_STATE_DIR`, default `~/.littlebaby`) - it'll read your soul docs and get weird ideas about the org chart!
