...
export const fr: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Modifier littlebaby.json.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Sur mobile ? Copiez l’URL complète (y compris #token=...) depuis littlebaby dashboard --no-open sur votre ordinateur.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — réauthentifiez-vous avec littlebaby models auth",
