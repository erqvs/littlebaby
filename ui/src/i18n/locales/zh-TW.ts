...
export const zh_TW: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "在手機上？從桌面執行 littlebaby dashboard --no-open 複製完整 URL（包括 #token=...）。",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — 使用 littlebaby models auth 重新驗證",
