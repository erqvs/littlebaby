...
export const ko: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "모바일에서 사용 중이신가요? 데스크톱에서 littlebaby dashboard --no-open으로 전체 URL(#token=... 포함)을 복사하세요.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — littlebaby models auth로 다시 인증하세요",
