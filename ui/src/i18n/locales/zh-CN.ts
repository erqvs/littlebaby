...
export const zh_CN: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "在手机上？从桌面运行 littlebaby dashboard --no-open 复制完整 URL（包括 #token=...）。",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — 使用 littlebaby models auth 重新认证",
