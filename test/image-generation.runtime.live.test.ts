...
const providerFilter = parseCsvFilter(process.env.LITTLEBABY_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.LITTLEBABY_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.LITTLEBABY_LIVE_IMAGE_GENERATION_MODELS);
