...
const WORKER_RUNTIME_STATE = Symbol.for("littlebaby.testSetupRuntimeState");
const WORKER_RUNTIME_HELPERS = Symbol.for("littlebaby.testSetupRuntimeHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: LittleBabyConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
