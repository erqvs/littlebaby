...
function resolveSignalMaxBytes(cfg: LittleBabyConfig, accountId?: string): number | undefined {
...
function resolveSignalTextChunkLimit(cfg: LittleBabyConfig, accountId?: string | null): number {
  const signalCfg = cfg.channels?.signal as
    | {
