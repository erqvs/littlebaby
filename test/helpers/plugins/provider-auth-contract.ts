...
type LoginOpenAICodexOAuth =
  (typeof import("littlebaby/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("littlebaby/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("littlebaby/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("littlebaby/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("littlebaby/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("littlebaby/plugin-sdk/provider-auth-login")>(
    "littlebaby/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("littlebaby/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("littlebaby/plugin-sdk/provider-auth")>(
    "littlebaby/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
