...
Nostr DM channel plugin for LittleBaby using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to LittleBaby. It enables your bot to:
...
# Configure littlebaby to use local relay
