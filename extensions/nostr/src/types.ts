...
import { normalizeSecretInputString, type SecretInput } from "littlebaby/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: LittleBabyConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: LittleBabyConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: LittleBabyConfig): string {
