...
export function applyOpencodeGoProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeGoConfig(cfg: LittleBabyConfig): LittleBabyConfig {
