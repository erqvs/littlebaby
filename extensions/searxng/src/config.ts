...
export function resolveSearxngCategories(config?: LittleBabyConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: LittleBabyConfig): string | undefined {
