...
import { createWebSearchProviderContractFields } from "littlebaby/plugin-sdk/provider-web-search-config-contract";
...
export function createBraveWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.littlebaby.ai/brave-search",
    autoDetectOrder: 10,
