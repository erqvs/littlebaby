...
import { createDedupeCache } from "littlebaby/plugin-sdk/infra-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("littlebaby/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
