...
import type { SessionScope } from "littlebaby/plugin-sdk/config-runtime";
import { createConnectedChannelStatusPatch } from "littlebaby/plugin-sdk/gateway-runtime";
import { DEFAULT_GROUP_HISTORY_LIMIT } from "littlebaby/plugin-sdk/reply-history";
import { normalizeMainKey } from "littlebaby/plugin-sdk/routing";
import { warn } from "littlebaby/plugin-sdk/runtime-env";
import {
  computeBackoff,
...
import { normalizeResolvedSecretInputString } from "littlebaby/plugin-sdk/secret-input";
import { normalizeStringEntries } from "littlebaby/plugin-sdk/text-runtime";
import { installRequestBodyLimitGuard } from "littlebaby/plugin-sdk/webhook-request-guards";
...
export async function monitorSlackProvider(opts: MonitorSlackOpts = {}) {
  ...
  // See: littlebaby/littlebaby#56508
