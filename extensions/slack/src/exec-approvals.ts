...
import { doesApprovalRequestMatchChannelAccount } from "littlebaby/plugin-sdk/approval-native-runtime";
import type { LittleBabyConfig } from "littlebaby/plugin-sdk/config-runtime";
import { normalizeStringifiedOptionalString } from "littlebaby/plugin-sdk/text-runtime";
...
function resolveSlackOwnerApprovers(cfg: LittleBabyConfig): string[] {
