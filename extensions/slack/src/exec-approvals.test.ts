...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<LittleBabyConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<LittleBabyConfig["channels"]>["slack"]>>,
): LittleBabyConfig {
  return {
    channels: {
      slack: {
