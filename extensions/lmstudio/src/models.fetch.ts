import { createSubsystemLogger } from "littlebaby/plugin-sdk/logging-core";
import type { ModelDefinitionConfig } from "littlebaby/plugin-sdk/provider-model-shared";
import { SELF_HOSTED_DEFAULT_COST } from "littlebaby/plugin-sdk/provider-setup";
import { fetchWithSsrFGuard, type SsrFPolicy } from "littlebaby/plugin-sdk/ssrf-runtime";
...
/** Discovers LLM models from LM Studio and maps them to LittleBaby model definitions. */
