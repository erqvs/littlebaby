...
import { withAgentModelAliases } from "littlebaby/plugin-sdk/provider-onboard";
import {
...
function stripLmstudioStoredAuthConfig(cfg: LittleBabyConfig): LittleBabyConfig {
...
function mergeDiscoveredLmstudioAllowlistEntries(params: {
  existing?: NonNullable<NonNullable<LittleBabyConfig["agents"]>["defaults"]>["models"];
  discoveredModels: ModelDefinitionConfig[];
}) {
