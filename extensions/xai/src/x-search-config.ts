...
export function resolveLegacyXSearchConfig(config?: LittleBabyConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: LittleBabyConfig): JsonRecord | undefined {
...
export function resolveEffectiveXSearchConfig(config?: LittleBabyConfig): JsonRecord | undefined {
