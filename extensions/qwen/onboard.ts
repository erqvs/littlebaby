...
const qwenPresetAppliers = createModelCatalogPresetAppliers<[string]>({
  ...
  resolveParams: (_cfg: LittleBabyConfig, baseUrl: string) => {
...
export function applyQwenProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return qwenPresetAppliers.applyProviderConfig(cfg, QWEN_GLOBAL_BASE_URL);
}

export function applyQwenProviderConfigCn(cfg: LittleBabyConfig): LittleBabyConfig {
  return qwenPresetAppliers.applyProviderConfig(cfg, QWEN_CN_BASE_URL);
}

export function applyQwenConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_GLOBAL_BASE_URL);
}

export function applyQwenConfigCn(cfg: LittleBabyConfig): LittleBabyConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_CN_BASE_URL);
}

export function applyQwenStandardProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return qwenPresetAppliers.applyProviderConfig(cfg, QWEN_STANDARD_GLOBAL_BASE_URL);
}

export function applyQwenStandardProviderConfigCn(cfg: LittleBabyConfig): LittleBabyConfig {
  return qwenPresetAppliers.applyProviderConfig(cfg, QWEN_STANDARD_CN_BASE_URL);
}

export function applyQwenStandardConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_STANDARD_GLOBAL_BASE_URL);
}

export function applyQwenStandardConfigCn(cfg: LittleBabyConfig): LittleBabyConfig {
