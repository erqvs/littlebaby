...
describe("browser control evaluate gating", () => {
  beforeEach(async () => {
    ...
    prevGatewayPort = process.env.LITTLEBABY_GATEWAY_PORT;
    process.env.LITTLEBABY_GATEWAY_PORT = String(testPort - 2);
    prevGatewayToken = process.env.LITTLEBABY_GATEWAY_TOKEN;
    prevGatewayPassword = process.env.LITTLEBABY_GATEWAY_PASSWORD;
