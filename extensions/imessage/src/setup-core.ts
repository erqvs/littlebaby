...
export const imessageDmPolicy = {
  ...
  resolveConfigKeys: (_cfg: LittleBabyConfig, accountId?: string) => {
...
function resolveIMessageCliPath(params: { cfg: LittleBabyConfig; accountId: string }) {
...
export const imessageCompletionNote = {
  ...
  lines: [
    ...
    "Ensure LittleBaby has Full Disk Access to Messages DB.",
...
export const imessageSetupStatusBase = {
  ...
  configuredScore: 1,
  unconfiguredScore: 0,
  resolveConfigured: ({ cfg, accountId }: { cfg: LittleBabyConfig; accountId?: string }) =>
