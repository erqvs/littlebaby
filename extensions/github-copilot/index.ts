import { definePluginEntry, type ProviderAuthContext } from "littlebaby/plugin-sdk/plugin-entry";
import { ensureAuthProfileStore } from "littlebaby/plugin-sdk/provider-auth";
