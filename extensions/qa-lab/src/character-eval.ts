...
\`\`\``;
  ...
  const prompt = `You are grading LittleBaby natural character conversation transcripts for naturalness, vibes, and funniness.
...
function renderCharacterEvalReport(params: {
  ...
  const lines = [
    "# LittleBaby Character Eval Report",
    "",
