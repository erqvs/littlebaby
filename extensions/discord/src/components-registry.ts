...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("littlebaby.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("littlebaby.discord.modalEntries");
