...
import { collectProviderDangerousNameMatchingScopes } from "littlebaby/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: LittleBabyConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: LittleBabyConfig,
  doctorFixCommand: string,
): { config: LittleBabyConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: LittleBabyConfig): string[] {
