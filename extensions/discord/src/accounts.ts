...
import type { DiscordAccountConfig, DiscordActionConfig, LittleBabyConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: LittleBabyConfig): ResolvedDiscordAccount[] {
