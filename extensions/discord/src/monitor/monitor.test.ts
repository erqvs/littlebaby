...
import { buildPluginBindingApprovalCustomId } from "littlebaby/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  const createCfg = (): LittleBabyConfig =>
    ({
      channels: {
        discord: {
          replyToMode: "first",
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/littlebaby-sessions-test.json");
