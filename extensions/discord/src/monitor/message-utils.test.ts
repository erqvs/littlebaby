...
vi.mock("littlebaby/plugin-sdk/media-runtime", async () => {
  const actual = await vi.importActual<typeof import("littlebaby/plugin-sdk/media-runtime")>(
    "littlebaby/plugin-sdk/media-runtime",
  );
  return {
    ...actual,
