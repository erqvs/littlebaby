...
import type { ModelsProviderData } from "littlebaby/plugin-sdk/models-provider-runtime";
import { normalizeProviderId } from "littlebaby/plugin-sdk/provider-model-shared";
...
let modelsProviderRuntimePromise:
  | Promise<typeof import("littlebaby/plugin-sdk/models-provider-runtime")>
  | undefined;

async function loadModelsProviderRuntime() {
  modelsProviderRuntimePromise ??= import("littlebaby/plugin-sdk/models-provider-runtime");
