...
import { resolveCommandAuthorizedFromAuthorizers } from "littlebaby/plugin-sdk/command-auth-native";
import type { DiscordAccountConfig, LittleBabyConfig } from "littlebaby/plugin-sdk/config-runtime";
...
import { logError } from "littlebaby/plugin-sdk/text-runtime";
import {
