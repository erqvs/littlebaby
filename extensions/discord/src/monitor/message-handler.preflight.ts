...
import { formatAllowlistMatchMeta } from "littlebaby/plugin-sdk/allow-from";
import {
  buildMentionRegexes,
...
import { resolveControlCommandGate } from "littlebaby/plugin-sdk/command-auth-native";
import { hasControlCommand } from "littlebaby/plugin-sdk/command-detection";
import { shouldHandleTextCommands } from "littlebaby/plugin-sdk/command-surface";
import { isDangerousNameMatchingEnabled, loadConfig } from "littlebaby/plugin-sdk/config-runtime";
import type { SessionBindingRecord } from "littlebaby/plugin-sdk/conversation-binding-runtime";
import { enqueueSystemEvent, recordChannelActivity } from "littlebaby/plugin-sdk/infra-runtime";
import {
  recordPendingHistoryEntryIfEnabled,
  type HistoryEntry,
} from "littlebaby/plugin-sdk/reply-history";
import { getChildLogger, logVerbose, shouldLogVerbose } from "littlebaby/plugin-sdk/runtime-env";
import { logDebug, normalizeOptionalString } from "littlebaby/plugin-sdk/text-runtime";
...
let conversationRuntimePromise:
  | Promise<typeof import("littlebaby/plugin-sdk/conversation-binding-runtime")>
  | undefined;
...
async function loadConversationRuntime() {
  conversationRuntimePromise ??= import("littlebaby/plugin-sdk/conversation-binding-runtime");
