...
import type { SessionBindingRecord } from "littlebaby/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "littlebaby/plugin-sdk/reply-history";
...
export type LoadedConfig = ReturnType<
  typeof import("littlebaby/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("littlebaby/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("littlebaby/plugin-sdk/config-runtime").LittleBabyConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
