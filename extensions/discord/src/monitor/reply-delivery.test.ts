...
vi.mock("littlebaby/plugin-sdk/retry-runtime", async () => {
  const actual = await vi.importActual<typeof import("littlebaby/plugin-sdk/retry-runtime")>(
    "littlebaby/plugin-sdk/retry-runtime",
  );
  return {
    ...actual,
