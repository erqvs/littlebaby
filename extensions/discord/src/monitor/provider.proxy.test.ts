...
vi.mock("littlebaby/plugin-sdk/proxy-capture", () => ({
  ...
  resolveEffectiveDebugProxyUrl: (configuredProxyUrl?: string) =>
    configuredProxyUrl?.trim() || process.env.LITTLEBABY_DEBUG_PROXY_URL,
...
describe("createDiscordGatewayPlugin", () => {
  ...
  beforeEach(() => {
    vi.unstubAllEnvs();
    vi.stubEnv("LITTLEBABY_DEBUG_PROXY_ENABLED", "");
    vi.stubEnv("LITTLEBABY_DEBUG_PROXY_URL", "");
