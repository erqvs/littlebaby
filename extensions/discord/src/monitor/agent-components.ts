...
import { isDangerousNameMatchingEnabled } from "littlebaby/plugin-sdk/dangerous-name-runtime";
import { resolveMarkdownTableMode } from "littlebaby/plugin-sdk/markdown-table-runtime";
import { getAgentScopedMediaLocalRoots } from "littlebaby/plugin-sdk/media-runtime";
import { createNonExitingRuntime, logVerbose } from "littlebaby/plugin-sdk/runtime-env";
import { resolveOpenProviderRuntimeGroupPolicy } from "littlebaby/plugin-sdk/runtime-group-policy";
import { logDebug, logError } from "littlebaby/plugin-sdk/text-runtime";
...
let replyPipelineRuntimePromise:
  | Promise<typeof import("littlebaby/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("littlebaby/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__littlebaby_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__littlebaby_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__littlebaby_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__littlebaby_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__littlebaby_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__littlebaby_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "LittleBaby form";
  customId = "__littlebaby_discord_component_modal_wildcard__";
  components = [];
