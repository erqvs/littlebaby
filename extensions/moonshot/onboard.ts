...
export function applyMoonshotProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return moonshotPresetAppliers.applyProviderConfig(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: LittleBabyConfig): LittleBabyConfig {
  return moonshotPresetAppliers.applyProviderConfig(cfg, MOONSHOT_CN_BASE_URL);
}

export function applyMoonshotConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return moonshotPresetAppliers.applyConfig(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotConfigCn(cfg: LittleBabyConfig): LittleBabyConfig {
