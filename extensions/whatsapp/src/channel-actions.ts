...
function areWhatsAppAgentReactionsEnabled(params: { cfg: LittleBabyConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: LittleBabyConfig) {
