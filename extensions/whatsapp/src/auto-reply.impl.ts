export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "littlebaby/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "littlebaby/plugin-sdk/reply-runtime";
