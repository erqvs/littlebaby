...
import type { BaseTokenResolution } from "littlebaby/plugin-sdk/channel-contract";
import { tryReadSecretFileSync } from "littlebaby/plugin-sdk/channel-core";
...
function resolveEnvSecretRefValue(params: {
  cfg?: Pick<LittleBabyConfig, "secrets">;
  provider: string;
  id: string;
