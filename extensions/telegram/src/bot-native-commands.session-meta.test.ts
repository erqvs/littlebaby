...
type ResolveConfiguredBindingRouteFn =
  typeof import("littlebaby/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("littlebaby/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/littlebaby-sessions.json");
