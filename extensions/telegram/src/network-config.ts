...
import { isTruthyEnvValue, isWSL2Sync } from "littlebaby/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "littlebaby/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "LITTLEBABY_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "LITTLEBABY_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "LITTLEBABY_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable LITTLEBABY_TELEGRAM_DNS_RESULT_ORDER
