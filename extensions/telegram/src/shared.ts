import { resolveNormalizedAccountEntry } from "littlebaby/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "littlebaby/plugin-sdk/channel-core";
import { getChatChannelMeta } from "littlebaby/plugin-sdk/channel-plugin-common";
 ...
 *
 * See: https://github.com/littlebaby/littlebaby/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: LittleBabyConfig, accountId: string): boolean {
