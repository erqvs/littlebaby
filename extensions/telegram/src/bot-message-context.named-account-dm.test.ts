...
let clearRuntimeConfigSnapshot: typeof import("littlebaby/plugin-sdk/config-runtime").clearRuntimeConfigSnapshot;
let setRuntimeConfigSnapshot: typeof import("littlebaby/plugin-sdk/config-runtime").setRuntimeConfigSnapshot;
