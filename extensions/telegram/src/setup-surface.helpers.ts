...
export function shouldShowTelegramDmAccessWarning(cfg: LittleBabyConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`littlebaby config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`littlebaby config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
