...
export function applyXiaomiProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return xiaomiPresetAppliers.applyProviderConfig(cfg);
}

export function applyXiaomiConfig(cfg: LittleBabyConfig): LittleBabyConfig {
