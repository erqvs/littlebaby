...
vi.mock("littlebaby/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("littlebaby/plugin-sdk/channel-pairing", () => ({
...
vi.mock("littlebaby/plugin-sdk/command-auth", () => ({
...
vi.mock("littlebaby/plugin-sdk/config-runtime", () => ({
...
vi.mock("littlebaby/plugin-sdk/group-access", () => ({
...
vi.mock("littlebaby/plugin-sdk/routing", () => ({
