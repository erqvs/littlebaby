import type { ChannelSetupAdapter, LittleBabyConfig } from "littlebaby/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "littlebaby/plugin-sdk/setup";
...
export function isLineConfigured(cfg: LittleBabyConfig, accountId: string): boolean {
