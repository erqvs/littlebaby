...
type RegisteredLineCardCommand = Parameters<LittleBabyPluginApi["registerCommand"]>[0];

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: LittleBabyPluginApi): Promise<RegisteredLineCardCommand> {
