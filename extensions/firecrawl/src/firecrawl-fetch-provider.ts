import type { WebFetchProviderPlugin } from "littlebaby/plugin-sdk/provider-web-fetch";
import { enablePluginInConfig } from "littlebaby/plugin-sdk/provider-web-fetch";
