...
vi.mock("littlebaby/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("littlebaby/plugin-sdk/hook-runtime")>(
    "littlebaby/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
