...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/littlebaby-matrix-create-client-test",
    storagePath: "/tmp/littlebaby-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/littlebaby-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/littlebaby-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/littlebaby-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "littlebaby-matrix-default-token-hash",
