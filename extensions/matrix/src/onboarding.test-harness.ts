import type { OutputRuntimeEnv } from "littlebaby/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "littlebaby/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "LittleBaby Gateway",
    },
    confirm: {
