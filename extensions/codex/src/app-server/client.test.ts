...
describe("CodexAppServerClient", () => {
  ...
  it("reads the Codex version from the app-server user agent", () => {
    ...
    expect(readCodexVersionFromUserAgent("littlebaby/0.118.0 (macOS; test)")).toBe("0.118.0");
    ...
    expect(readCodexVersionFromUserAgent("littlebaby/0.118.0abc")).toBeUndefined();
