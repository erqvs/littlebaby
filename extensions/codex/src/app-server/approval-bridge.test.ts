import { callGatewayTool, type EmbeddedRunAttemptParams } from "littlebaby/plugin-sdk/agent-harness";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { buildApprovalResponse, handleCodexAppServerApprovalRequest } from "./approval-bridge.js";

vi.mock("littlebaby/plugin-sdk/agent-harness", async (importOriginal) => ({
  ...(await importOriginal<typeof import("littlebaby/plugin-sdk/agent-harness")>()),
