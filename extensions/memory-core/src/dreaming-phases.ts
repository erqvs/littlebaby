...
import {
  ...
  sessionPathForFile,
} from "littlebaby/plugin-sdk/memory-core-host-engine-qmd";
import type { MemorySearchResult } from "littlebaby/plugin-sdk/memory-core-host-runtime-files";
import {
...
const LIGHT_SLEEP_EVENT_TEXT = "__littlebaby_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__littlebaby_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- littlebaby:dreaming:light:start -->",
    endMarker: "<!-- littlebaby:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- littlebaby:dreaming:rem:start -->",
    endMarker: "<!-- littlebaby:dreaming:rem:end -->",
  },
] as const;
 ...
 */
export function registerMemoryDreamingPhases(_api: LittleBabyPluginApi): void {
