import { peekSystemEventEntries } from "littlebaby/plugin-sdk/infra-runtime";
import type { LittleBabyConfig, LittleBabyPluginApi } from "littlebaby/plugin-sdk/memory-core";
import {
...
} from "littlebaby/plugin-sdk/memory-core-host-status";
...
const DREAMING_SYSTEM_EVENT_TEXT = "__littlebaby_memory_core_short_term_promotion_dream__";
...
function resolveStartupConfigFromEvent(event: unknown, fallback: LittleBabyConfig): LittleBabyConfig {
  ...
  return startupCfg as LittleBabyConfig;
}
...
export function registerShortTermPromotionDreaming(api: LittleBabyPluginApi): void {
