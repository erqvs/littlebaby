...
export function applyOpencodeZenProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: LittleBabyConfig): LittleBabyConfig {
