...
export function applyDeepSeekProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
...
export function applyDeepSeekConfig(cfg: LittleBabyConfig): LittleBabyConfig {
