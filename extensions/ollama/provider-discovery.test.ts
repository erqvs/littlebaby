...
import type { ModelDefinitionConfig } from "littlebaby/plugin-sdk/provider-onboard";
import { type LittleBabyConfig, withFetchPreconnect } from "littlebaby/plugin-sdk/testing";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "littlebaby-test-"));
  ...
  async function runOllamaCatalog(params: { config?: LittleBabyConfig; env?: NodeJS.ProcessEnv }) {
