...
import { buildApiKeyCredential } from "littlebaby/plugin-sdk/provider-auth";
import {
  ...
  register(api: LittleBabyPluginApi) {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "littlebaby configure". ' +
        "See: https://docs.littlebaby.ai/providers/ollama",
    });
  },
});
