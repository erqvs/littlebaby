...
This package contains the **BlueBubbles external channel plugin** for LittleBaby.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `littlebaby/plugin-sdk` helpers.
