...
import { collectIssuesForEnabledAccounts } from "littlebaby/plugin-sdk/status-helpers";
    ...
    collectIssues: ({ account, accountId, issues }) => {
      ...
      if (!configured) {
        issues.push({
          ...
          fix: "Run: littlebaby channels add bluebubbles --http-url <server-url> --password <password>",
        });
        return;
      }
