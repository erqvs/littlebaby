...
import { lowercasePreservingWhitespace } from "littlebaby/plugin-sdk/text-runtime";
...
function resolveMediaLocalRoots(params: { cfg: LittleBabyConfig; accountId?: string }): string[] {
