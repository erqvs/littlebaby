...
import { dispatchInboundReplyWithBase } from "littlebaby/plugin-sdk/inbound-reply-dispatch";
import {
...
export async function handleQaInbound(params: {
  ...
  const route = runtime.channel.routing.resolveAgentRoute({
    cfg: params.config as LittleBabyConfig,
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as LittleBabyConfig),
    body: inbound.text,
  });
