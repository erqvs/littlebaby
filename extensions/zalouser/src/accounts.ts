...
function mergeZalouserAccountConfig(cfg: LittleBabyConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: LittleBabyConfig; accountId?: string | null }) {
