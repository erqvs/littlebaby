...
vi.mock("littlebaby/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("littlebaby/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("littlebaby/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("littlebaby/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("littlebaby/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("littlebaby/plugin-sdk/webhook-ingress");
  return {
    ...actual,
