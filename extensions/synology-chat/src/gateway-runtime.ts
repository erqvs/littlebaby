import { DEFAULT_ACCOUNT_ID, type LittleBabyConfig } from "littlebaby/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "littlebaby/plugin-sdk/webhook-ingress";
