import { assertOkOrThrowHttpError, postJsonRequest } from "littlebaby/plugin-sdk/provider-http";
...
} from "littlebaby/plugin-sdk/speech-core";
import { asObject, trimToUndefined } from "littlebaby/plugin-sdk/speech-core";
...
function resolveGoogleTtsModelProviderApiKey(cfg?: LittleBabyConfig): string | undefined {
