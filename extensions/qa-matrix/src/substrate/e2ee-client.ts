...
import type {
  ...
  MessageEventContent,
} from "@littlebaby/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@littlebaby/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } =
    await import("littlebaby/plugin-sdk/qa-runner-runtime");
