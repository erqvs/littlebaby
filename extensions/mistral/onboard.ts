...
export function applyMistralProviderConfig(cfg: LittleBabyConfig): LittleBabyConfig {
  return mistralPresetAppliers.applyProviderConfig(cfg);
}

export function applyMistralConfig(cfg: LittleBabyConfig): LittleBabyConfig {
