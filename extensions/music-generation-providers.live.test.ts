...
const providerFilter = parseCsvFilter(process.env.LITTLEBABY_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.LITTLEBABY_LIVE_MUSIC_GENERATION_MODELS);
