...
vi.mock("littlebaby/plugin-sdk/msteams", () => ({
...
vi.mock("littlebaby/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("littlebaby/plugin-sdk/text-runtime")>();
  return {
    ...actual,
