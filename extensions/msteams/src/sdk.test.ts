...
describe("createMSTeamsApp", () => {
  it("does not crash with express 5 path-to-regexp (#55161)", async () => {
    // Regression test for: https://github.com/littlebaby/littlebaby/issues/55161
...
describe("createMSTeamsAdapter", () => {
  ...
  it("passes the LittleBaby User-Agent to the Bot Framework connector client", async () => {
    const creds = {
      type: "secret",
      appId: "app-id",
      appPassword: "secret",
