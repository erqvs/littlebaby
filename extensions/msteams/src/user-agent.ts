...
function resolveLittleBabyVersion(): string {
  try {
 ...
 * and appends the LittleBaby version.
 *
 * Format: "teams.ts[apps]/<sdk-version> LittleBaby/<littlebaby-version>"
 * Example: "teams.ts[apps]/2.0.5 LittleBaby/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} LittleBaby/${resolveLittleBabyVersion()}`;
  return cachedUserAgent;
}
