...
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "littlebaby/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "littlebaby/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: LittleBabyPluginApi) {
