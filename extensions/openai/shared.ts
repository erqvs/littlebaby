...
import { findCatalogTemplate } from "littlebaby/plugin-sdk/provider-catalog-shared";
import {
  cloneFirstTemplateModel,
  matchesExactOrPrefix,
  type ProviderPlugin,
} from "littlebaby/plugin-sdk/provider-model-shared";
import { OPENAI_RESPONSES_STREAM_HOOKS } from "littlebaby/plugin-sdk/provider-stream-family";
...
export function resolveConfiguredOpenAIBaseUrl(cfg: LittleBabyConfig | undefined): string {
