import type { ProviderRuntimeModel } from "littlebaby/plugin-sdk/plugin-entry";
  ...
  it("builds native turn state for direct OpenAI routes", () => {
    expect(
      ...
      headers: {
        ...
        "x-littlebaby-session-id": "session-123",
        "x-littlebaby-turn-id": "turn-123",
        "x-littlebaby-turn-attempt": "2",
      },
      metadata: {
        littlebaby_session_id: "session-123",
        littlebaby_turn_id: "turn-123",
        littlebaby_turn_attempt: "2",
        littlebaby_transport: "websocket",
      },
    });
  });
