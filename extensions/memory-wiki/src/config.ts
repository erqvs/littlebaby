...
import { buildPluginConfigSchema, z, type LittleBabyPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: LittleBabyPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".littlebaby", "wiki", "main");
}
