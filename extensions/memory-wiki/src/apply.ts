...
const GENERATED_START = "<!-- littlebaby:wiki:generated:start -->";
const GENERATED_END = "<!-- littlebaby:wiki:generated:end -->";
const HUMAN_START = "<!-- littlebaby:human:start -->";
const HUMAN_END = "<!-- littlebaby:human:end -->";
