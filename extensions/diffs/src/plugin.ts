...
import { resolvePreferredLittleBabyTmpDir, type LittleBabyPluginApi } from "../api.js";
import {
...
export function registerDiffsPlugin(api: LittleBabyPluginApi): void {
  ...
  const store = new DiffArtifactStore({
    rootDir: path.join(resolvePreferredLittleBabyTmpDir(), "littlebaby-diffs"),
    logger: api.logger,
  });
