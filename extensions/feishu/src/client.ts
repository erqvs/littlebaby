...
const FEISHU_USER_AGENT = `littlebaby-feishu-builtin/${pluginVersion}/${process.platform}`;
...
export const FEISHU_HTTP_TIMEOUT_ENV_VAR = "LITTLEBABY_FEISHU_HTTP_TIMEOUT_MS";
