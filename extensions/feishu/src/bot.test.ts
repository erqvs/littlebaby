import type * as ConversationRuntime from "littlebaby/plugin-sdk/conversation-runtime";
...
async function dispatchMessage(params: { cfg: LittlebabyConfig; event: FeishuMessageEvent }) {
