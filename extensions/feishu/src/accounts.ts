import {
  DEFAULT_ACCOUNT_ID,
  type LittleBabyConfig as LittlebabyConfig,
  createAccountListHelpers,
  normalizeAccountId,
  normalizeOptionalAccountId,
  resolveMergedAccountConfig,
} from "littlebaby/plugin-sdk/account-resolution";
import { coerceSecretRef } from "littlebaby/plugin-sdk/provider-auth";
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: LittlebabyConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: LittlebabyConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: LittlebabyConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: LittlebabyConfig): ResolvedFeishuAccount[] {
