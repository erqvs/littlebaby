...
export function resolveVitestIsolation(
  ...
  const forceIsolation = env.LITTLEBABY_TEST_ISOLATE === "1" || env.LITTLEBABY_TEST_ISOLATE === "true";
  if (forceIsolation) {
    return true;
  }
  return env.LITTLEBABY_TEST_NO_ISOLATE === "0" || env.LITTLEBABY_TEST_NO_ISOLATE === "false";
}
