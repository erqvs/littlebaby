...
- macOS logs: use `./scripts/clawlog.sh` to query unified logs for the LittleBaby subsystem; it supports follow/tail/category filters and expects passwordless sudo for `/usr/bin/log`.
