    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            Text(
              "Approve this phone on the gateway. LittleBaby retries automatically while this screen stays open.",
              style = mobileCallout,
              color = mobileTextSecondary,
            )
          ...
          Text("LittleBaby Android ${littleBabyAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text("Copy Report for LittleBaby", style = mobileCallout.copy(fontWeight = FontWeight.Bold))
          }
        }
      }
    }
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("littlebaby qr --setup-code-only")
          CommandBlock("littlebaby qr --json")
          Text(
