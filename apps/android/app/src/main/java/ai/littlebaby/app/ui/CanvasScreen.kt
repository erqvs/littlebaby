  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("LittleBabyWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            ...
            override fun onReceivedError(
              ...
              Log.e("LittleBabyWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              currentPageUrlRef.set(url)
              if (isDebuggable) {
                Log.d("LittleBabyWebView", "onPageFinished: $url")
              }
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "littlebabyCanvasA2UIAction"
  }
}
