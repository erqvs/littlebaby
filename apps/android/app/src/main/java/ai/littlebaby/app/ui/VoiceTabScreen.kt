...
import ai.littlebaby.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("LittleBaby is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
