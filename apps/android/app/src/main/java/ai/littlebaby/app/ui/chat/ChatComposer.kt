...
import ai.littlebaby.app.ui.mobileAccentBorderStrong
...
import ai.littlebaby.app.ui.mobileSurface
import ai.littlebaby.app.ui.mobileText
import ai.littlebaby.app.ui.mobileTextSecondary
import ai.littlebaby.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.littlebaby.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.littlebaby.app.ui.mobileFontFamily,
