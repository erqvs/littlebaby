...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.littlebaby", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.littlebaby", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [LittleBabyChatMessage] = messages.compactMap { item in
