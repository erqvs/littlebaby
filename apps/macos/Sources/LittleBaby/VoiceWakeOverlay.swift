...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.littlebaby", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other LittleBaby windows, but below the system’s pop-up menus.
