...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.littlebaby", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return LittleBabyConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - LittleBaby Workspace
