...
/// Menu contents for the LittleBaby menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About LittleBaby") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "LittleBaby Not Configured"
        case .remote:
            "Remote LittleBaby Active"
        case .local:
            "LittleBaby Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .littlebabySelectSettingsTab, object: tab)
        }
    }
