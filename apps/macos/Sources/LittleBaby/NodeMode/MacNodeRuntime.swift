...
actor MacNodeRuntime {
    ...
    func handleInvoke(_ req: BridgeInvokeRequest) async -> BridgeInvokeResponse {
        ...
        do {
            ...
            case LittleBabyBrowserCommand.proxy.rawValue:
            ...
            case LittleBabyLocationCommand.get.rawValue:
            ...
            case LittleBabySystemCommand.run.rawValue:
                return try await self.handleSystemRun(req)
            case LittleBabySystemCommand.which.rawValue:
                return try await self.handleSystemWhich(req)
            case LittleBabySystemCommand.notify.rawValue:
                return try await self.handleSystemNotify(req)
            case LittleBabySystemCommand.execApprovalsGet.rawValue:
                return try await self.handleSystemExecApprovalsGet(req)
            case LittleBabySystemCommand.execApprovalsSet.rawValue:
    ...
    private func handleA2UIInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        ...
        case LittleBabyCanvasA2UICommand.push.rawValue,
             LittleBabyCanvasA2UICommand.pushJSONL.rawValue:
    ...
    private func handleBrowserProxyInvoke(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        guard LittleBabyConfigFile.browserControlEnabled() else {
            return BridgeInvokeResponse(
                id: req.id,
                ok: false,
                error: LittleBabyNodeError(
    ...
    private func resolveA2UIHostUrl() async -> String? {
        ...
        return baseUrl.appendingPathComponent("__littlebaby__/a2ui/").absoluteString + "?platform=macos"
    }
    ...
    private func handleSystemRun(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(LittleBabySystemRunParams.self, from: req.paramsJSON)
    ...
    private func handleSystemWhich(_ req: BridgeInvokeRequest) async throws -> BridgeInvokeResponse {
        let params = try Self.decodeParams(LittleBabySystemWhichParams.self, from: req.paramsJSON)
    ...
    private func resolveSystemRunApproval(
        ...
        params: LittleBabySystemRunParams,
...
extension MacNodeRuntime {
    ...
    private nonisolated static func locationMode() -> LittleBabyLocationMode {
    ...
    private static func errorResponse(
        ...
        code: LittleBabyNodeErrorCode,
        message: String) -> BridgeInvokeResponse
    {
        BridgeInvokeResponse(
            id: req.id,
            ok: false,
            error: LittleBabyNodeError(code: code, message: message))
    }

    private static func encodeCanvasSnapshot(
        image: NSImage,
        format: LittleBabyCanvasSnapshotFormat,
        maxWidth: Int?,
