...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .littlebabySelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? LittleBabyPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? LittleBabyPaths.stateDirURL.path
...
extension Notification.Name {
    static let littlebabySelectSettingsTab = Notification.Name("littlebabySelectSettingsTab")
}
