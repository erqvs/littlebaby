...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.littlebaby", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".littlebaby/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.littlebabyCommand(
            subcommand: "gateway",
