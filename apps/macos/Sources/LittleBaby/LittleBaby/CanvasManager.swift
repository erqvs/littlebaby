...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.littlebaby", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("LittleBaby/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__littlebaby__/a2ui/").absoluteString + "?platform=macos"
    }
