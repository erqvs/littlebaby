...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.littlebaby", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        LittleBabyPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        LittleBabyPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
