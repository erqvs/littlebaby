...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: LittleBabyProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": LittleBabyProtocol.AnyCodable("start"),
                "name": LittleBabyProtocol.AnyCodable("bash"),
            ],
            summary: nil)
