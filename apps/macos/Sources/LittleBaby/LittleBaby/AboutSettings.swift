...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/littlebaby/littlebaby") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/littlebaby/littlebaby")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://littlebaby.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "LittleBabyBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LittleBabyBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "LittleBabyGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "LittleBabyGitCommit") as? String) ??
            "unknown"
    }
