...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = LittleBabyConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = LittleBabyConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: LittleBabyConfigFile.loadDict(),
            draft: .init(
        ...
        LittleBabyConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/littlebaby"
        state.remoteCliPath = ""
        return state
    }
}
