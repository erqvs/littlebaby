...
enum UIStrings {
    static let welcomeTitle = "Welcome to LittleBaby"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "littlebaby.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: LittleBabyChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g littlebaby@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: LittleBabyChatViewModel(
