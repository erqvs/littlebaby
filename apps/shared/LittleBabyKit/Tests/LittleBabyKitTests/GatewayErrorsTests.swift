...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "littlebaby devices approve req-123",
            docsURLString: "https://docs.littlebaby.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "littlebaby devices approve req-123")
        #expect(error.docsURLString == "https://docs.littlebaby.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "littlebaby devices approve req-123")
    }
