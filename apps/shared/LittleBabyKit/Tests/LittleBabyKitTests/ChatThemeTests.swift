...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = LittleBabyChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = LittleBabyChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
