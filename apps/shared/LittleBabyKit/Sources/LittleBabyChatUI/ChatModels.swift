...
public typealias LittleBabyPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias LittleBabyPlatformImage = UIImage
#endif

public struct LittleBabyChatUsageCost: Codable, Hashable, Sendable {
...
public struct LittleBabyChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: LittleBabyChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(LittleBabyChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct LittleBabyChatMessageContent: Codable, Hashable, Sendable {
...
public struct LittleBabyChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [LittleBabyChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: LittleBabyChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [LittleBabyChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: LittleBabyChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(LittleBabyChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([LittleBabyChatMessageContent].self, forKey: .content) {
...
public struct LittleBabyChatHistoryPayload: Codable, Sendable {
...
public struct LittleBabySessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct LittleBabySessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [LittleBabySessionPreviewItem]
}

public struct LittleBabySessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [LittleBabySessionPreviewEntry]

    public init(ts: Int, previews: [LittleBabySessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct LittleBabyChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct LittleBabyChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct LittleBabyAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct LittleBabyChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct LittleBabyGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct LittleBabyPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: LittleBabyPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: LittleBabyPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct LittleBabyChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
