...
public struct LittleBabyChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct LittleBabyChatSessionsDefaults: Codable, Sendable {
...
public struct LittleBabyChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct LittleBabyChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: LittleBabyChatSessionsDefaults?
    public let sessions: [LittleBabyChatSessionEntry]
    ...
    public init(
        ...
        sessions: [LittleBabyChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
