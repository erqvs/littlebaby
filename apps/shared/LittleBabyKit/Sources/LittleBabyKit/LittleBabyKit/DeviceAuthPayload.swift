...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: LittleBabyProtocol.AnyCodable]?
    {
        ...
        return [
            "id": LittleBabyProtocol.AnyCodable(identity.deviceId),
            "publicKey": LittleBabyProtocol.AnyCodable(publicKey),
            "signature": LittleBabyProtocol.AnyCodable(signature),
            "signedAt": LittleBabyProtocol.AnyCodable(signedAtMs),
            "nonce": LittleBabyProtocol.AnyCodable(nonce),
        ]
    }
}
