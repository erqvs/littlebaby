...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.littlebaby", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.littlebaby", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: LittleBabyProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
