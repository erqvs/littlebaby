...
public enum LittleBabyTalkCommand: String, Codable, Sendable {
...
public struct LittleBabyTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct LittleBabyTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
