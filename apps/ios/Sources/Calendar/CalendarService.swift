...
final class CalendarService: CalendarServicing {
    func events(params: LittleBabyCalendarEventsParams) async throws -> LittleBabyCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            LittleBabyCalendarEventPayload(
        ...
        return LittleBabyCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: LittleBabyCalendarAddParams) async throws -> LittleBabyCalendarAddPayload {
        ...
        let payload = LittleBabyCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return LittleBabyCalendarAddPayload(event: payload)
    }
