...
extension NodeAppModel {
    func resolveCanvasHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__littlebaby__/canvas/").absoluteString
    }
    ...
    func resolveA2UIHostURL() async -> String? {
        ...
        return base.appendingPathComponent("__littlebaby__/a2ui/").absoluteString + "?platform=ios"
    }
