...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: LittleBabyPhotosLatestParams) async throws -> LittleBabyPhotosLatestPayload {
        ...
        var results: [LittleBabyPhotoPayload] = []
        ...
        return LittleBabyPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> LittleBabyPhotoPayload
    {
