...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.littlebaby.gateway"
    private static let nodeService = "ai.littlebaby.node"
    private static let talkService = "ai.littlebaby.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.littlebaby.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.littlebaby.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("littlebaby-gateway.log")
    }
