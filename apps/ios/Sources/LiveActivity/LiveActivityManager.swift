...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.littlebaby.ios", category: "LiveActivity")
    private var currentActivity: Activity<LittleBabyActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = LittleBabyActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<LittleBabyActivityAttributes>.activities
    ...
    private func updateCurrent(state: LittleBabyActivityAttributes.ContentState) {
    ...
    private func connectingState() -> LittleBabyActivityAttributes.ContentState {
        LittleBabyActivityAttributes.ContentState(
    ...
    private func idleState() -> LittleBabyActivityAttributes.ContentState {
        LittleBabyActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> LittleBabyActivityAttributes.ContentState {
        LittleBabyActivityAttributes.ContentState(
