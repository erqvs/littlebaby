...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = LittleBabyLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = LittleBabyLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.littlebaby.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        ...
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your LittleBaby agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected LittleBaby agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while LittleBaby is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for LittleBaby. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(LittleBabyLocationMode.off.rawValue)
                            Text("While Using").tag(LittleBabyLocationMode.whileUsing.rawValue)
                            Text("Always").tag(LittleBabyLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while LittleBaby is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("LittleBaby", value: DeviceInfoHelper.littleBabyVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = LittleBabyLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your LittleBaby chat and run /pair approve, then tap Connect again."
        }
