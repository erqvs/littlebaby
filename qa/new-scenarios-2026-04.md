...
- Code: `.agents/skills/littlebaby-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Flow:
  - Install a LittleBabyHub or gateway-managed skill.
...
- Code: `src/agents/littlebaby-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
