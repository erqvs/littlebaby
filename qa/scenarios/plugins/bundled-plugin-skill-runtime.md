...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as LITTLEBABY_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                HOME: homeDir,
                LITTLEBABY_HOME: homeDir,
                LITTLEBABY_CONFIG_PATH: configPath,
                LITTLEBABY_STATE_DIR: stateDir,
                LITTLEBABY_OAUTH_DIR: path.join(stateDir, "credentials"),
                LITTLEBABY_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
