...
execution:
  kind: flow
  summary: Run with `pnpm littlebaby qa suite --provider-mode live-frontier --model openai/gpt-5.4 --alt-model openai/gpt-5.4 --scenario medium-game-plan-pi-harness`.
  config:
