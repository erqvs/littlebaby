...
- use `pnpm littlebaby qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the LittleBaby QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this LittleBaby repo from source + docs before acting.
