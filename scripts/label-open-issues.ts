...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "littlebaby", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for LittleBaby. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("LittleBaby Issue Label Audit");
