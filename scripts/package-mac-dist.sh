...
# Output:
# - dist/LittleBaby.app
# - dist/LittleBaby-<version>.zip
# - dist/LittleBaby-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.littlebaby.mac}"
...
APP="$ROOT_DIR/dist/LittleBaby.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/LittleBaby-$VERSION.zip"
DMG="$ROOT_DIR/dist/LittleBaby-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/LittleBaby-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/LittleBaby-$VERSION.dSYM.zip"
