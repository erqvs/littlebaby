...
function parseArgs(argv) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readEnvNumber("LITTLEBABY_TEST_PERF_MAX_WALL_MS"),
      baselineWallMs: readEnvNumber("LITTLEBABY_TEST_PERF_BASELINE_WALL_MS"),
