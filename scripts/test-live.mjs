...
const env = {
  ...process.env,
  LITTLEBABY_LIVE_TEST: process.env.LITTLEBABY_LIVE_TEST || "1",
  LITTLEBABY_LIVE_TEST_QUIET: quietOverride ?? process.env.LITTLEBABY_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.LITTLEBABY_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
