...
const opts = parseFlagArgs(
  process.argv.slice(2),
  {
    ...
    report: "",
    entry: "littlebaby.mjs",
    preset: "all",
    runs: 1,
    warmup: 0,
    timeoutMs: 30_000,
    maxDurationRegressionPct:
      readEnvNumber("LITTLEBABY_STARTUP_BENCH_MAX_DURATION_REGRESSION_PCT") ?? 20,
    maxRssRegressionPct: readEnvNumber("LITTLEBABY_STARTUP_BENCH_MAX_RSS_REGRESSION_PCT") ?? 20,
  },
  [
