...
CDP_PORT="${LITTLEBABY_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${LITTLEBABY_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${LITTLEBABY_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${LITTLEBABY_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${LITTLEBABY_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${LITTLEBABY_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${LITTLEBABY_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${LITTLEBABY_BROWSER_NOVNC_PASSWORD:-}"

DISABLE_GRAPHICS_FLAGS="${LITTLEBABY_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${LITTLEBABY_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${LITTLEBABY_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
AUTO_START_TIMEOUT_MS="${LITTLEBABY_BROWSER_AUTO_START_TIMEOUT_MS:-12000}"
...
if [[ -z "${CDP_SOURCE_RANGE}" ]]; then
  ...
  echo "[sandbox-browser] Set LITTLEBABY_BROWSER_CDP_SOURCE_RANGE to an explicit CIDR to enable CDP access." >&2
else
