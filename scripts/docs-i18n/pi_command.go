...
const (
	envDocsPiExecutable     = "LITTLEBABY_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "LITTLEBABY_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "LITTLEBABY_DOCS_I18N_PI_PACKAGE_VERSION"
	envDocsPiOmitProvider   = "LITTLEBABY_DOCS_I18N_PI_OMIT_PROVIDER"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "littlebaby", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
