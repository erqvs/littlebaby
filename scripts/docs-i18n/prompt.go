...
- Keep product names in English: LittleBaby, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the LittleBaby Gateway, use “Gateway 网关”.
