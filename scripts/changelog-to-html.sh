...
if [[ -z "$version_content" ]]; then
  echo "<h2>LittleBaby $VERSION</h2>"
  echo "<p>Latest LittleBaby update.</p>"
  echo "<p><a href=\"https://github.com/littlebaby/littlebaby/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
