...
const ENV_PROVIDER = "LITTLEBABY_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "LITTLEBABY_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "LITTLEBABY_CONTROL_UI_I18N_THINKING";
const ENV_PI_EXECUTABLE = "LITTLEBABY_CONTROL_UI_I18N_PI_EXECUTABLE";
const ENV_PI_ARGS = "LITTLEBABY_CONTROL_UI_I18N_PI_ARGS";
const ENV_PI_PACKAGE_VERSION = "LITTLEBABY_CONTROL_UI_I18N_PI_PACKAGE_VERSION";
const ENV_BATCH_CHAR_BUDGET = "LITTLEBABY_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "LITTLEBABY_CONTROL_UI_I18N_PROMPT_TIMEOUT";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "LittleBaby", target: "LittleBaby" },
