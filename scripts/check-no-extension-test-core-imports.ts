...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']littlebaby\/plugin-sdk["']/,
    hint: "Use littlebaby/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']littlebaby\/plugin-sdk\/test-utils["']/,
    hint: "Use littlebaby/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']littlebaby\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/plugins/* for repo-only helpers, or littlebaby/plugin-sdk/testing for public surfaces.",
  },
  {
