...
const codexRepo = process.env.LITTLEBABY_CODEX_REPO
  ? path.resolve(process.env.LITTLEBABY_CODEX_REPO)
...
console.log(
  `Codex app-server generated protocol matches LittleBaby bridge assumptions: ${schemaRoot}`,
);
