...
<Steps>
  ...
  <Step title="Create persistent host directories">
    ...
    ```bash
    mkdir -p /root/.littlebaby/workspace

    # Set ownership to the container user (uid 1000):
    chown -R 1000:1000 /root/.littlebaby
    ```
  ...
  <Step title="Configure environment variables">
    ...
    LITTLEBABY_CONFIG_DIR=/root/.littlebaby
    LITTLEBABY_WORKSPACE_DIR=/root/.littlebaby/workspace
