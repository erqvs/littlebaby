---
summary: "Backstory and lore of LittleBaby for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "LittleBaby Lore"
---
...
**The Handle Snipers:** Within SECONDS of the Twitter rename, automated bots sniped @littlebaby. The squatter immediately posted a crypto wallet address. Peter's contacts at X were called in.
...
- GitHub renamed: `github.com/littlebaby/littlebaby` ✅
- X handle `@littlebaby` secured with GOLD CHECKMARK 💰
- npm packages released under new name
- Docs migrated to `docs.littlebaby.ai`
