---
summary: "First-run setup flow for LittleBaby (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give LittleBaby">
...
<Step title="CLI">
  ...
  The app can install the global `littlebaby` CLI via npm, pnpm, or bun.
