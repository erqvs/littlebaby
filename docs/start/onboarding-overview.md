---
summary: "Overview of LittleBaby onboarding options and flows"
read_when:
...
LittleBaby has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `littlebaby onboard`                     | Launch the app            |
...
CLI command docs: [`littlebaby onboard`](/cli/onboard)

## macOS app onboarding

Open the LittleBaby app. The first-run wizard walks you through the same steps
