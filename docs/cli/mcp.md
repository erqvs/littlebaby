...
# Remote Gateway
openclaw mcp serve --url wss://gateway-host:18789 --token-file ~/.littlebaby/gateway.token

# Remote Gateway with password auth
openclaw mcp serve --url wss://gateway-host:18789 --password-file ~/.littlebaby/gateway.password
