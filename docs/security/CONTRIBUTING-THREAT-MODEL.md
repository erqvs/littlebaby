...
summary: "How to contribute to the LittleBaby threat model"
read_when:
  - You want to contribute security findings or threat scenarios
  - Reviewing or updating the threat model
---

# Contributing to the LittleBaby Threat Model

Thanks for helping make LittleBaby more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.

## Ways to Contribute

### Add a Threat

Spotted an attack vector or risk we haven't covered? Open an issue on [littlebaby/trust](https://github.com/littlebaby/trust/issues) and describe it in your own words. You don't need to know any frameworks or fill in every field - just describe the scenario.
...
> **This is for adding to the threat model, not reporting live vulnerabilities.** If you've found an exploitable vulnerability, see our [Trust page](https://trust.littlebaby.ai) for responsible disclosure instructions.
...
- [LittleBaby Threat Model](/security/THREAT-MODEL-ATLAS)

## Contact

- **Security vulnerabilities:** See our [Trust page](https://trust.littlebaby.ai) for reporting instructions
- **Threat model questions:** Open an issue on [littlebaby/trust](https://github.com/littlebaby/trust/issues)
- **General chat:** Discord #security channel

## Recognition

Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the LittleBaby security hall of fame for significant contributions.
