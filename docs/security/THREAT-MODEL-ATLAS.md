...
summary: "LittleBaby threat model mapped to the MITRE ATLAS framework"
read_when:
  - Reviewing security posture or threat scenarios
  - Working on security features or audit responses
---

# LittleBaby Threat Model v1.0
...
This is a living document maintained by the LittleBaby community. See [CONTRIBUTING-THREAT-MODEL.md](/security/CONTRIBUTING-THREAT-MODEL) for guidelines on contributing:
...
| **Description**         | Attacker scans for exposed LittleBaby gateway endpoints                |
...
| **Affected Components** | ~/.littlebaby/credentials/, config storage                    |
...
| ATLAS ID      | Technique Name                 | LittleBaby Threats                                                 |
| ------------- | ------------------------------ | ---------------------------------------------------------------- |
...
| **Skill**            | Downloadable extension for LittleBaby agents                |
| **SSRF**             | Server-Side Request Forgery                               |

---

_This threat model is a living document. Report security issues to security@littlebaby.ai_
