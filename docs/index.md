---
summary: "LittleBaby is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing LittleBaby to newcomers
title: "LittleBaby"
---
...
<p align="center">
    <img
        src="/assets/littlebaby-logo-text-dark.png"
        alt="LittleBaby"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/littlebaby-logo-text.png"
        alt="LittleBaby"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install LittleBaby and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `littlebaby onboard` and pairing flows.
  </Card>
...
LittleBaby is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents like Pi. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-littlebaby.jpg" alt="LittleBaby" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.littlebaby/littlebaby.json`.

- If you **do nothing**, LittleBaby uses the bundled Pi binary in RPC mode with per-sender sessions.
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@littlebaby"] } },
}
```
