...
It is modeled after Claude Code's `/btw` behavior, but adapted to LittleBaby's
...
If the main run is currently active, LittleBaby snapshots the current message
