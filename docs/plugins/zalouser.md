...
read_when:
  - You want Zalo Personal (unofficial) support in LittleBaby
...
Zalo Personal support for LittleBaby via a plugin, using native `zca-js` to automate a normal Zalo user account.
