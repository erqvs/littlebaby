---
summary: "Community-maintained LittleBaby plugins: browse, install, and submit your own"
read_when:
  - You want to find third-party LittleBaby plugins
...
Independent LittleBaby bridge for Codex App Server conversations. Bind a chat to
a Codex thread, talk to it with plain text, and control it with chat-native
commands for resume, planning, review, model selection, compaction, and more.

- **npm:** `littlebaby-codex-app-server`
- **repo:** [github.com/pwrdrvr/littlebaby-codex-app-server](https://github.com/pwrdrvr/littlebaby-codex-app-server)
...
- **repo:** [github.com/largezhou/littlebaby-dingtalk](https://github.com/largezhou/littlebaby-dingtalk)
...
- **npm:** `@opik/opik-littlebaby`
- **repo:** [github.com/comet-ml/opik-littlebaby](https://github.com/comet-ml/opik-littlebaby)

```bash
littlebaby plugins install @opik/opik-littlebaby
```

### QQbot

Connect LittleBaby to QQ via the QQ Bot API. Supports private chats, group
mentions, channel messages, and rich media including voice, images, videos,
and files.

- **npm:** `@tencent-connect/littlebaby-qqbot`
- **repo:** [github.com/tencent-connect/littlebaby-qqbot](https://github.com/tencent-connect/littlebaby-qqbot)

```bash
littlebaby plugins install @tencent-connect/littlebaby-qqbot
```

### wecom

WeCom channel plugin for LittleBaby by the Tencent WeCom team. Powered by
...
- **npm:** `@wecom/wecom-littlebaby-plugin`
- **repo:** [github.com/WecomTeam/wecom-littlebaby-plugin](https://github.com/WecomTeam/wecom-littlebaby-plugin)

```bash
littlebaby plugins install @wecom/wecom-littlebaby-plugin
```
