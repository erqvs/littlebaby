...
<Steps>
  ...
  <Step title="Configure LittleBaby">
    Point LittleBaby at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or LittleBaby
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native LittleBaby integration with Claude CLI or API keys.
  </Card>
