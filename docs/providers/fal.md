---
title: "fal"
summary: "fal image and video generation setup in LittleBaby"
read_when:
  - You want to use fal image generation in LittleBaby
...
LittleBaby ships a bundled `fal` provider for hosted image and video generation.
...
<Steps>
  <Step title="Set the API key">
    ```bash
    littlebaby onboard --auth-choice fal-api-key
    ```
  </Step>
...
<Tip>
Use `littlebaby models list --provider fal` to see the full list of available fal
