---
summary: "Use Qianfan's unified API to access many models in LittleBaby"
read_when:
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    littlebaby onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    littlebaby models list --provider qianfan
    ```
  </Step>
</Steps>
