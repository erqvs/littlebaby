...
Deepgram is a speech-to-text API. In LittleBaby it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, LittleBaby uploads the audio file to Deepgram and injects the transcript
...
<Steps>
  ...
  <Step title="Send a voice note">
    Send an audio message through any connected channel. LittleBaby transcribes it
...
<Note>
Deepgram transcription is **pre-recorded only** (not real-time streaming). LittleBaby
