---
summary: "Use NVIDIA's OpenAI-compatible API in LittleBaby"
read_when:
  - You want to use open models in LittleBaby for free
...
<Steps>
  ...
  <Step title="Export the key and run onboarding">
    ...
    littlebaby onboard --auth-choice skip
    ```
  </Step>
  <Step title="Set an NVIDIA model">
    ```bash
    littlebaby models set nvidia/nvidia/nemotron-3-super-120b-a12b
    ```
  </Step>
</Steps>
