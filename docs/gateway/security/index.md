...
- If someone can modify Gateway host state/config (`~/.littlebaby`, including `openclaw.json`), treat them as a trusted operator.
...
| ------------------------------------------------------------- | ------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------- | -------- |
| `fs.state_dir.perms_world_writable`                           | critical      | Other users/processes can modify full OpenClaw state                                 | filesystem perms on `~/.littlebaby`                                                                    | yes      |
| `fs.state_dir.perms_group_writable`                           | warn          | Group users can modify full OpenClaw state                                           | filesystem perms on `~/.littlebaby`                                                                    | yes      |
...
| `fs.config.perms_writable`                                    | critical      | Others can change auth/tool policy/config                                            | filesystem perms on `~/.littlebaby/openclaw.json`                                                      | yes      |
...
OpenClaw stores session transcripts on disk under `~/.littlebaby/agents/<agentId>/sessions/*.jsonl`.
...
- `~/.littlebaby/openclaw.json`: `600` (user read/write only)
