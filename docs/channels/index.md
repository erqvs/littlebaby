---
summary: "Messaging platforms LittleBaby can connect to"
read_when:
  - You want to choose a chat channel for LittleBaby
...
LittleBaby can talk to you on any chat app you already use. Each channel connects via the Gateway.
...
- Channels can run simultaneously; configure multiple and LittleBaby will route per chat.
