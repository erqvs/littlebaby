---
title: "QA Channel"
summary: "Synthetic Slack-class channel plugin for deterministic LittleBaby QA scenarios"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated LittleBaby QA.
...
- LittleBaby-native orchestration later
