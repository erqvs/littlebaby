---
summary: "Use SOUL.md to give your LittleBaby agent an actual voice instead of generic assistant sludge"
read_when:
...
LittleBaby injects it on normal sessions, so it has real weight. If your agent
...
For LittleBaby, `SOUL.md` is that layer.
...
## The LittleBaby prompt

Paste this into your agent and let it rewrite `SOUL.md`.

Path fixed for LittleBaby workspaces: use `SOUL.md`, not `http://SOUL.md`.
