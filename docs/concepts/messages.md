...
This page ties together how LittleBaby handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. LittleBaby keeps a
...
LittleBaby separates the **prompt body** from the **command body**:
...
LittleBaby can expose or hide model reasoning:
