...
LittleBaby also runs a separate idempotent cleanup for older legacy sessions that
...
LittleBaby auto-enables pruning for Anthropic profiles:
...
If you set explicit values, LittleBaby does not override them.
