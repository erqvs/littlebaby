...
LittleBaby treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.littlebaby/settings/voicewake.json`

Shape:

```json
{ "triggers": ["littlebaby", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
