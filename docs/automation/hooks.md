...
| command-logger        | `command`                      | Logs all commands to `~/.littlebaby/logs/commands.log`  |
...
Logs every slash command to `~/.littlebaby/logs/commands.log`.
...
ls -la ~/.littlebaby/hooks/my-hook/
