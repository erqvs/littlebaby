...
```bash
HOME=/home/littlebaby LITTLEBABY_STATE_DIR=/home/littlebaby/.littlebaby pnpm db:migrate
```

导入长期上下文文档：

```bash
HOME=/home/littlebaby LITTLEBABY_STATE_DIR=/home/littlebaby/.littlebaby pnpm context:import
```
