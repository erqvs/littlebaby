...
- Workspace root: `~/.littlebaby/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.littlebaby/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.littlebaby/openclaw.json` (model + defaults):
