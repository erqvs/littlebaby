...
- Use `--repo littlebaby/littlebaby` with `--match title,body` first.
...
```bash
gh search prs --repo littlebaby/littlebaby --match title,body --limit 50 -- "auto-update"
gh search issues --repo littlebaby/littlebaby --match title,body --limit 50 -- "auto-update"
gh search issues --repo littlebaby/littlebaby --match title,body --limit 50 \
