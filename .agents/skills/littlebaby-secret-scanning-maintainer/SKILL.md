---
name: littlebaby-secret-scanning-maintainer
description: Maintainer-only workflow for handling GitHub Secret Scanning alerts on LittleBaby. Use when Codex needs to triage, redact, clean up, and resolve secret leakage found in issue comments, issue bodies, PR comments, or other GitHub content.
---

# LittleBaby Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/littlebaby/littlebaby/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/littlebaby-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/littlebaby/littlebaby/issues/63101#issuecomment-xxx",
